...
$pages = array(
	...
	'construction' => nuvirahub_get_page_by_title( 'Construction' ),
);
...
<div class="nv-section nv-reveal">
	<div class="nv-pillars">
		...
		<a class="nv-pillar" href="<?php echo esc_url( $url( $pages['construction'], 'construction' ) ); ?>">
			<div class="nv-pillar-num">08</div>
			<div class="nv-pillar-icon"><?php echo nv_icon( 'hard-hat', 32 ); ?></div>
			<h3>Construction &amp; Architecture</h3>
			<p>House design, drawings, BIM, project planning, construction and property sales.</p>
			<span class="nv-pillar-cta">Learn more →</span>
		</a>
	</div>
</div>
